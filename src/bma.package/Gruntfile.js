        ...
        copy: {
            ...
            prebuild: {
                files: [
                    ...
                    { src: '../../packages/jQuery/Content/Scripts/jquery-2.1.4.js', dest: '../bma.client/Scripts/jquery-2.1.4.js' },
                    { src: '../../packages/jQuery/Content/Scripts/jquery-2.1.4.min.js', dest: '../bma.client/Scripts/jquery-2.1.4.min.js' },
                    { src: '../../packages/jQuery/Content/Scripts/jquery-2.1.4.min.map', dest: '../bma.client/Scripts/jquery-2.1.4.min.map' },
                    ...
                    { src: 'node_modules/regular-table/dist/umd/regular-table.js', dest: '../bma.client/js/regular-table/regular-table.js' },
                    { src: 'node_modules/regular-table/dist/css/material.css', dest: '../bma.client/js/regular-table/material.css' },
                ]
            }
        },
        less: {
