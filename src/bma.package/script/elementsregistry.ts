                ...
                this.elements.push(new BboxElement(
                    ...
                    function (renderParams) {
                        ...
                        if (!renderParams.textOnly) {
                            ...
                            var path = jqSvg.createPath();
                            var variable = jqSvg.path(g, path, {
                                stroke: renderParams.isSelected ? "#CF15D0" : pathFill, //'blue' : 'transparent',
                                fill: pathFill,
                                strokeWidth: 30,
                                d: data,
                                transform: "scale(0.03 -0.03) translate(-500 -470)" //"scale(0.25)"
                ...
                this.elements.push(new BboxElement(
                    ...
                    function (renderParams) {
                        ...
                        if (!renderParams.textOnly) {
                            ...
                            angle += 180;
                            var variable = jqSvg.path(g, path, {
                                stroke: renderParams.isSelected ? "#055B7E" : pathFill, //'blue' : 'transparent',
                                fill: pathFill,
                                strokeWidth: 30,
                                d: data,
                                transform: " scale(0.03) " + "rotate(" + angle + ")" + " translate(-270 -435)" //"scale(1.2) rotate(" + angle + ")"
                            });
