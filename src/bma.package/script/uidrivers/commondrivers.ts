    ...
    export module UIDrivers {
        ...
        export class SVGPlotDriver implements ISVGPlot, IElementsPanel, INavigationPanel, IAreaHightlighter {
            ...
            DrawCanvasFrame(canvas: HTMLCanvasElement) {
                this.svgPlotDiv.drawingsurface({ canvasFrame: canvas });
            }
        ...
        export class ModelStorageDriver implements IModelStorageDriver {
            ...
            public SetLinkToModelByName(callback: Function) {
                this.widget.modelstoragewidget({
                    getmodelbyname: callback
                });
            }

            public SetLinkToModelByInfo(callback: Function) {
                this.widget.modelstoragewidget({
                    getmodelbyinfo: callback
                });
            }
